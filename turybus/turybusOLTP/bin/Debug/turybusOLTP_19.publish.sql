...
GO
PRINT N'Modificando Tabla [seguridad].[pasajeros]...';


GO
ALTER TABLE [seguridad].[pasajeros]
    ADD [rowversion] TIMESTAMP NOT NULL;


GO
PRINT N'Modificando Tabla [transporte].[autobuses_conductores]...';
...
GO
PRINT N'Modificando Tabla [transporte].[billetes]...';
...
GO
PRINT N'Modificando Tabla [transporte].[estadisticas_uso]...';
...
GO
PRINT N'Modificando Tabla [transporte].[lugares_recorrido]...';
...
GO
PRINT N'Modificando Tabla [transporte].[revisiones_reparaciones]...';
...
GO
PRINT N'Modificando Tabla [transporte].[rutas_servicios]...';
