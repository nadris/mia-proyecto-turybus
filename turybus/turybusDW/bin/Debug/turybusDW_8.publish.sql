...
CREATE TABLE [dwh].[dim_autobuses] (
    [AutobusesSK] INT            IDENTITY (1, 1) NOT NULL,
    [matricula]   NVARCHAR (20)  NOT NULL,
    [modelo]      NVARCHAR (255) NOT NULL,
    [fabricante]  NVARCHAR (255) NOT NULL,
    [num_plazas]  INT            NOT NULL,
    PRIMARY KEY CLUSTERED ([AutobusesSK] ASC),
...
CREATE TABLE [dwh].[dim_rutas_servicios] (
    [RutasServiciosSK] INT             IDENTITY (1, 1) NOT NULL,
    [id_ruta_servicio] INT             NOT NULL,
    [nombre]           NVARCHAR (255)  NOT NULL,
    [importe]          DECIMAL (10, 2) NOT NULL,
    PRIMARY KEY CLUSTERED ([RutasServiciosSK] ASC)
);
...
CREATE TABLE [dwh].[hechos_viajes] (
    [HechosViajesSK]   INT           IDENTITY (1, 1) NOT NULL,
    [AutobusesSK]      INT           NOT NULL,
    [ConductoresSK]    INT           NOT NULL,
    [PasajerosSK]      INT           NOT NULL,
    [RutasServiciosSK] INT           NOT NULL,
    [dni_pasajero]     NVARCHAR (20) NOT NULL,
    [id_ruta_servicio] INT           NOT NULL,
    [matricula]        NVARCHAR (20) NOT NULL,
    [dni_conductor]    NVARCHAR (20) NOT NULL,
    PRIMARY KEY CLUSTERED ([HechosViajesSK] ASC)
);
...
CREATE TABLE [dwh].[dim_pasajeros] (
    [PasajerosSK] INT            IDENTITY (1, 1) NOT NULL,
    [dni]         NVARCHAR (20)  NOT NULL,
    [nombre]      NVARCHAR (255) NOT NULL,
    [telefono]    NVARCHAR (20)  NOT NULL,
    PRIMARY KEY CLUSTERED ([PasajerosSK] ASC),
    UNIQUE NONCLUSTERED ([dni] ASC)
);


GO
PRINT N'Creando Clave externa [dwh].[fk_autobuses]...';


GO
ALTER TABLE [dwh].[hechos_viajes]
    ADD CONSTRAINT [fk_autobuses] FOREIGN KEY ([AutobusesSK]) REFERENCES [dwh].[dim_autobuses] ([AutobusesSK]);


GO
PRINT N'Creando Clave externa [dwh].[fk_conductores]...';


GO
ALTER TABLE [dwh].[hechos_viajes]
    ADD CONSTRAINT [fk_conductores] FOREIGN KEY ([ConductoresSK]) REFERENCES [dwh].[dim_conductores] ([ConductoresSK]);


GO
PRINT N'Creando Clave externa [dwh].[fk_pasajeros]...';


GO
ALTER TABLE [dwh].[hechos_viajes]
    ADD CONSTRAINT [fk_pasajeros] FOREIGN KEY ([PasajerosSK]) REFERENCES [dwh].[dim_pasajeros] ([PasajerosSK]);


GO
PRINT N'Creando Clave externa [dwh].[fk_rutas_servicios]...';


GO
ALTER TABLE [dwh].[hechos_viajes]
    ADD CONSTRAINT [fk_rutas_servicios] FOREIGN KEY ([RutasServiciosSK]) REFERENCES [dwh].[dim_rutas_servicios] ([RutasServiciosSK]);
